...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<List<CustomResponse>> newResponseErrors(MethodArgumentNotValidException e) {
        ...
        List<CustomResponse> errorResponseList = new ArrayList<>();

        for (FieldError fieldError : fieldErrors) {
            CustomResponse errorResponse = new CustomResponse(HttpStatus.UNPROCESSABLE_ENTITY.toString(), fieldError.getDefaultMessage());
        ...
        ResponseEntity<List<CustomResponse>> responseEntity = new ResponseEntity<>(errorResponseList, HttpStatus.UNPROCESSABLE_ENTITY);
    ...
    public ResponseEntity<CustomResponse> notFoundException(NotFoundException e) {
