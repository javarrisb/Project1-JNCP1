...
function GamesCard({ games, notify }) {
    ...
    function handleDelete() {
        fetch((`http://localhost:8080/games`), {method: "Delete"})
    ...
    return (
        <tr key={games.id}>
            ...
            <td>
                ...
                <button id="editButton" className="btn btn-secondary" type="button" onClick={() => notify({ action: "edit-form", games: games })}>Edit</button>
            </td>
        </tr>
    );
}
